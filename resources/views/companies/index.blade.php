<x-app-layout>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h2 class="font-bold text-xl text-slate-900 flex items-center gap-2">
                    <i class="fa-solid fa-building text-slate-700"></i> Direktori Perusahaan Terverifikasi
                </h2>
    ...
    <div class="py-10 bg-slate-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <!-- Search & Filter Card -->
            <div class="bg-white rounded-2xl p-5 shadow-2xs border border-slate-200">
                        ...
                        <div class="bg-white rounded-2xl p-6 border border-slate-200 shadow-2xs hover:border-slate-400 transition flex flex-col justify-between space-y-4">
                            <div class="space-y-3">
                                <div class="flex items-start justify-between gap-3">
                                    <div class="w-12 h-12 bg-slate-900 text-white rounded-xl flex items-center justify-center font-bold text-xl border border-slate-900 shrink-0">
                                        🏢
                                    </div>
                                    @if($comp->is_verified)
                            ...
                            <div class="pt-4 border-t border-slate-200 flex items-center justify-between">
                                ...
                                <a href="{{ route('companies.show', urlencode($comp->name)) }}" class="text-slate-900 hover:text-slate-700 font-bold text-xs flex items-center gap-1">
                                    Lihat Profil &rarr;
                                </a>
                            </div>
                        </div>
