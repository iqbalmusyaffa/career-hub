        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="font-bold text-xl text-slate-900 tracking-tight flex items-center gap-2">
                    ...
                    <span class="text-blue-600 font-bold">{{ $job->title }}</span>
                </h2>
                <p class="text-xs text-slate-500 mt-0.5">Perbarui rincian kualifikasi, kuota, kompensasi, atau status publikasi lowongan.</p>
            </div>
        </div>
    </x-slot>
                ...
                <form action="{{ route('admin.jobs.update', $job->id) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <div class="border-b border-slate-100 pb-3 mb-4 flex flex-wrap justify-between items-center gap-2">
                            ...
                            @if(!auth()->user()->hasRole('Super Admin'))
                                <span class="text-[11px] font-semibold text-slate-500 flex items-center gap-1.5 bg-slate-50 px-2.5 py-1 rounded-lg border border-slate-200">
                                    ...
                                    <strong class="text-slate-900">{{ $companyProfile->company_name ?? ($job->company_name ?? 'Perusahaan Mitra') }}</strong>
                                </span>
                            @endif
                        </div>
                        ...
                        @if(!auth()->user()->hasRole('Super Admin'))
                                ...
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-bold text-slate-900 text-sm mt-0.5 flex items-center gap-1.5">
                                            <span>{{ $companyProfile->company_name ?? ($job->company_name ?? 'Perusahaan Mitra') }}</span>
                            ...
                            <input type="hidden" name="company_name" value="{{ $companyProfile->company_name ?? ($job->company_name ?? 'Perusahaan Mitra') }}">
                        @else
                            <div class="mb-4">
                                <x-input-label for="company_name" :value="__('Perusahaan Penyelenggara')" class="text-xs font-semibold text-slate-700" />
                                <x-text-input id="company_name" name="company_name" type="text" list="company_list_options" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500" :value="old('company_name', $job->company_name)" placeholder="Pilih atau ketik nama perusahaan..." required />
                                ...
                                <p class="text-[10px] text-slate-400 mt-1">Sebagai Super Admin, Anda dapat memindahkan lowongan ke perusahaan mitra mana pun.</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="title" name="title" type="text" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500" :value="old('title', $job->title)" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="division" name="division" type="text" list="division_options" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500" :value="old('division', $job->division)" required />
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select id="work_type" name="work_type" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500 bg-white" required>
                                    <option value="Full-time" {{ old('work_type', $job->work_type) == 'Full-time' ? 'selected' : '' }}>Full-Time (WFO)</option>
                                    <option value="Hybrid" {{ old('work_type', $job->work_type) == 'Hybrid' ? 'selected' : '' }}>Hybrid (WFO & Remote)</option>
                                    <option value="Remote" {{ old('work_type', $job->work_type) == 'Remote' ? 'selected' : '' }}>Remote (100% Work from Anywhere)</option>
                                    <option value="Part-time" {{ old('work_type', $job->work_type) == 'Part-time' ? 'selected' : '' }}>Part-Time</option>
                                    <option value="Contract" {{ old('work_type', $job->work_type) == 'Contract' ? 'selected' : '' }}>Contract / Kontrak Proyek</option>
                            ...
                            <div>
                                ...
                                <select id="experience_level" name="experience_level" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500 bg-white">
                                    <option value="Semua Tingkat" {{ old('experience_level', $job->experience_level) == 'Semua Tingkat' ? 'selected' : '' }}>Semua Tingkat Pengalaman</option>
                                    <option value="Fresh Graduate" {{ old('experience_level', $job->experience_level) == 'Fresh Graduate' ? 'selected' : '' }}>Fresh Graduate (0-1 Tahun)</option>
                                    <option value="Junior Level" {{ old('experience_level', $job->experience_level) == 'Junior Level' ? 'selected' : '' }}>Junior Level (1-3 Tahun)</option>
                                    <option value="Mid Level" {{ old('experience_level', $job->experience_level) == 'Mid Level' ? 'selected' : '' }}>Mid Level (3-5 Tahun)</option>
                                    <option value="Senior Level" {{ old('experience_level', $job->experience_level) == 'Senior Level' ? 'selected' : '' }}>Senior Level (5+ Tahun)</option>
                                    <option value="Managerial" {{ old('experience_level', $job->experience_level) == 'Managerial' ? 'selected' : '' }}>Lead / Managerial</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="google_maps_link" name="google_maps_link" type="text" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 focus:ring-blue-500 focus:border-blue-500" :value="old('google_maps_link', $job->google_maps_link)" placeholder="https://maps.google.com/?q=..." />
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <x-text-input id="batch" name="batch" type="text" list="batch_options_list_edit_page" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 focus:ring-blue-500 focus:border-blue-500" :value="old('batch', $job->batch)" placeholder="Misal: Batch 1 - Semester Genap 2026" />
                                <datalist id="batch_options_list_edit_page">
                            ...
                            <div>
                                ...
                                <x-text-input id="duration" name="duration" type="text" list="duration_options_list_edit_page" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 focus:ring-blue-500 focus:border-blue-500" :value="old('duration', $job->duration)" placeholder="Misal: 6 Bulan / 3 Bulan / Tetap" />
                                <datalist id="duration_options_list_edit_page">
                            ...
                            <div>
                                ...
                                <x-text-input id="start_date" name="start_date" type="date" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 focus:ring-blue-500 focus:border-blue-500" :value="old('start_date', optional($job->start_date)->format('Y-m-d'))" />
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                                ...
                                <select id="education_level" name="education_level" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500 bg-white">
                                    <option value="Semua Jenjang" {{ old('education_level', $job->education_level) == 'Semua Jenjang' ? 'selected' : '' }}>Semua Jenjang</option>
                                    <option value="SMA/SMK" {{ old('education_level', $job->education_level) == 'SMA/SMK' ? 'selected' : '' }}>SMA / SMK Sederajat</option>
                                    <option value="D3" {{ old('education_level', $job->education_level) == 'D3' ? 'selected' : '' }}>D3 (Diploma 3)</option>
                                    <option value="D4/S1" {{ old('education_level', $job->education_level) == 'D4/S1' ? 'selected' : '' }}>D4 / S1 (Sarjana)</option>
                                    <option value="S2" {{ old('education_level', $job->education_level) == 'S2' ? 'selected' : '' }}>S2 (Magister)</option>
                                </select>
                            </div>

                            <div>
                                <x-input-label for="major_requirement" :value="__('Jurusan / Bidang Studi')" class="text-xs font-semibold text-slate-700" />
                                <x-text-input id="major_requirement" name="major_requirement" type="text" list="indonesia-majors-list" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500" :value="old('major_requirement', $job->major_requirement)" placeholder="Pilih atau ketik jurusan..." />
                            ...
                            <div>
                                ...
                                <select id="gender_requirement" name="gender_requirement" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500 bg-white">
                                    <option value="Pria & Wanita" {{ old('gender_requirement', $job->gender_requirement) == 'Pria & Wanita' ? 'selected' : '' }}>Pria & Wanita (Terbuka Umum)</option>
                                    <option value="Khusus Pria" {{ old('gender_requirement', $job->gender_requirement) == 'Khusus Pria' ? 'selected' : '' }}>Khusus Pria</option>
                                    <option value="Khusus Wanita" {{ old('gender_requirement', $job->gender_requirement) == 'Khusus Wanita' ? 'selected' : '' }}>Khusus Wanita</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <x-text-input id="age_range" name="age_range" type="text" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500 pr-14" :value="old('age_range', $job->age_range)" placeholder="Contoh: 21 - 35 atau 30" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="skills_required" name="skills_required" type="text" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500" :value="old('skills_required', $job->skills_required)" placeholder="Misal: PHP, Laravel, MySQL, REST API, Docker" />
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <x-text-input id="salary" name="salary" type="text" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500" :value="old('salary', $job->salary)" placeholder="Misal: Sesuai UMK / Negosiasi" />
                            ...
                            <div>
                                ...
                                <x-text-input id="quota" name="quota" type="number" min="1" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500" :value="old('quota', $job->quota)" placeholder="Kosongkan jika tak terbatas" />
                            ...
                            <div>
                                ...
                                <x-text-input id="deadline" name="deadline" type="date" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500" :value="old('deadline', optional($job->deadline)->format('Y-m-d'))" required />
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea id="description" name="description" rows="4" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500" required placeholder="Jelaskan gambaran umum peran dan tugas utama sehari-hari...">{{ old('description', $job->description) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea id="requirements" name="requirements" rows="4" class="mt-1 block w-full rounded-lg text-xs font-medium border-slate-300 focus:ring-blue-500 focus:border-blue-500" required placeholder="Tuliskan persyaratan teknis, sertifikasi, dan kualifikasi yang diharapkan...">{{ old('requirements', $job->requirements) }}</textarea>
                            ...
                            @php
                                ...
                                $rawOldBenefits = old('benefits', $job->benefits);
                                $existingBenefits = $rawOldBenefits ? array_values(array_filter(array_map('trim', explode(',', $rawOldBenefits)))) : [];
                            @endphp
                            <div x-data="benefitSelector(@js($defaultBenefits), @js($existingBenefits))" class="space-y-2">
                            ...
                            <div>
                                <x-input-label for="status" :value="__('Status Publikasi Lowongan')" class="text-xs font-semibold text-slate-700" />
